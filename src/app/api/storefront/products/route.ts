...
export async function GET(req:Request){
 ...
 // Authoritative publication gate: valid product data, valid pricing, valid stock,
 // and >=4 reachable AI_VISION_VERIFIED images are required for storefront visibility.
