...
export async function POST(req: Request) {
  try {
    ...
    // Publication is a CEO decision. Research/creative agents can prepare a
    // candidate but cannot bypass this gate and publish directly.
    ...
    const description = String(ai.description || p.title).trim();
