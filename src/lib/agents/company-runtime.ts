...
const GROWTH_WORK: Array<{ agentId: OperationalAgentId; title: string; priority: number; instruction: string }> = [
  ...
  { agentId: "source-verification", title: "Verify sourcing and economics blockers", priority: 86, instruction: "Review the current catalog/source evidence and identify which products or source decisions are READY, HOLD or BLOCKED under live price, stock, shipping, policy, evidence freshness and margin gates." },
  ...
  { agentId: "image-media", title: "Repair truthful product media", priority: 84, instruction: "Inspect catalog media readiness. Resolve source-backed image gaps with technical validation and duplicate removal. Never use placeholders or claim AI vision when semantic vision was not performed." },
