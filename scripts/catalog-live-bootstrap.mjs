...
const base = process.env.BHARATSHOP_URL?.replace(/\/$/, '');
...
// Research in batches. Verification failures must not erase candidates; the API owns
// the VERIFIED/PUBLISHED gate and may leave rate-limited candidates pending.
